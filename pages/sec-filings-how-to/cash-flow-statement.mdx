...
- Data center assets abandonment : 데이터 센터 자산의 폐기 또는 포기
  ...
  - `2432 (Million)` : 2432 (Million) 은 원달러 환율 1350원일때 3.28조원에 해당하는 금액입니다. 노후된 데이터센터 폐기로 인한 자산 손실이 3.28 억원이네요. 데이터 센터 폐기와 같은 행동은 실제로 현금이 유출되었다고 볼수 있기에 -로 표기합니다. 
- Other : 기타 항목
